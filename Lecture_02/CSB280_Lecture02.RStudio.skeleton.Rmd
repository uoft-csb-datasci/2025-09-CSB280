...
Variables, as we've seen, can be assigned to one single value from any of the above atomic values. While it is the smallest possible "unit" of data within R, as we'll soon see, they are not actually stored as their own special data structure.

...
### 0.4.4.5 Dataset 5: /data/gapminder_wide.txt

The gapminder dataset is a popular example dataset in R. It contains socio-economic statistics across 60 years of data for countries around the world. This dataset include life expectancy, population size, and GDP per capita information. It is meant to highlight the potential disparity in wealth distribution across the world.
...
### 4.3.5 Use `select()` to rearrange your columns!
...
The third and fourth requirements have more to do with the *shape* of your data. Are both your sample populations from that bell-curve shaped distribution (Normality) AND are they both about the same width and height (homoscedastic). While we won't go too far in-depth into the theory of these requirements, we'll certainly learn a few tools on how to test for them.
